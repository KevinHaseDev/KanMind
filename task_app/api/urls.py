...
urlpatterns = [
    ...
    path('tasks/<int:task_id>/comments/', TaskCommentsListCreateView.as_view(), name="tasks-comments"),
    path('tasks/<int:task_id>/comments/<int:comment_id>/', TaskCommentDeleteView.as_view(), name="tasks-comment-delete"),
]
